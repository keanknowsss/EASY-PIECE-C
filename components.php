<?php
    ...
    function cartCard($business_name, $cart_id, $item_id,$item_name, $item_price, $item_qty, $item_img)
    {
        $x = '<div class="row column-card mb-3">
        <div class="order-card container-fluid">
            <div class="row justify-content-between ml-2 mr-2">
                    <p>Sold by: <a href="#" class="link-black-none">'.$business_name.'</a> <p><a href="">Remove</a></p>
            </div>
                <hr class="divider-1 divider-mod-1">
                    <div class="row container-fluid pb-5">
                        <div class="row row-order-brief container">
                            <div class="col-lg-2">
                                <div class="row">
                                    <input type="checkbox" name="item[]" id="" value="'.$cart_id.'" class="mr-3 mt-5">
                                    <a href="product.php?id='.$item_id.'" class="link-black-none"><img src="products/'.$item_img.'" alt="product img" class="" style="width: 9.5em; height:9em; margin-top: -0.7em; object-fit: cover;"></a>
                                </div>
                            </div>

                            <div class="col-5 d-block ml-4">
                                <a href="product.php?id='.$item_id.'" class="link-black-none">
                                    <p class="order-item-name">'.$item_name.'</p>
                                </a>
                            </div>
                        <div class="col-1 d-block">
                        ...
                        <div class="col">
                            <label for="quantity">Quantity:</label><br>
                                <input type="number" value="'.$item_qty.'" name="quantity" MIN="1" id="qty" class="addItem  inQty-widthMAX no-mx inQty rounded">
                        </div>
                    </div>
                </div>
            </div>
