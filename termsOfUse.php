...
<head>
    ...
    <title>Terms of Use | EASY PIECE C</title>
            ...
            <div class="container-fluid col-lg-12 col-md 12 col-sm-12" style="height:100vh">
               <div class="row justify-content-center">
                   <div class="col-8 test m-5 py-5 shadow p-3 mb-5 bg-white rounded" id="contentpt2">
                        <div class="row justify-content-center"><h1 class="browse-title"><strong>Terms Of Use</strong></h1></div>   
                        <div class="row justify-content-center">
                            <div class="hr-title rounded-pill"></div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col">
                                <p>Easy Piece C is a platform for selling Computer parts and for buying computer parts. An account must be created in order to buy or sell in this platform. Fraudulent accounts and scams are strictly prohibited in this website as it will result to the ban of your account. Here are the following things that is not allowed in this platform. 
                                </p>

                                <ul class="ml-5 mt-2">
                                    <li>Selling non computer related products</li>
                                    <li>Creating Fake Accounts</li>
                                    <li>Performing Cybercrimes</li>
                                    <li>Scamming your clients as a Business Owner</li>
