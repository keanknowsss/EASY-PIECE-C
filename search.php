...
<head>
    ...
    <title>Search | EASY PIECE C</title>
...
<body class="d-flex flex-column min-vh-100 content-bg">
    ...
    <div class="main-content some-container container-fluid pb-4 min-vh-100"  >
        <div class="row justify-content-center pt-3 mb-5 pb-5">
            <div class="container-fluid col-lg-12 col-md 12 col-sm-12">
                <div class="row mt-2 justify-content-center">
                    <h1 class="browse-title"><center><strong>SEARCH</strong></center></h1>
                </div>
                ...
                <?php
                    $sql = "SELECT * FROM additem WHERE Name = '$name'";
                    ...
                    if($result = mysqli_query($con, $sql))
                    {
                        ...
                        {
                            echo '<p class="msg-none justify-content-center" style="font-size: 3em;"><strong>NO ITEMS FOUND</strong></p>';
                        }
                        echo '</div>';     
